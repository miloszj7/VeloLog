...
| 3 | Rejection and degradation | Prove bad input and absent data produce deliberate states, never a server error or a blank page | #5, #6 | unit (parsing) + integration (view/template) | change opened | `context/changes/testing-rejection-and-degradation/` |
