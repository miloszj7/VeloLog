...
- **Engineering backlog triggered by this slice:** CI runs no tests/lint/type gates
  (trigger: "before S-03"); the `/data/db.sqlite3` restore path has never been exercised
  (trigger: "before the deploy following S-03").
